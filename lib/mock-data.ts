...
export const INITIAL_USERS: User[] = [
  ...
  {
    id: 'usr-owner-1',
    name: 'Malak Management',
    email: 'contact@hotelmalak.in',
...
export const INITIAL_MENU_ITEMS: MenuItem[] = [
  // === MAHARASHTRIAN HERITAGE SPECIALS ===
  {
    ...
    name: 'Royal Malak Maharashtrian Thali',
  ...
  // === STARTERS & SIZZLERS ===
  {
    ...
    restaurant_id: 'rest-1',
    category_id: 'cat-1',
    name: 'Malak Special Paneer Sizzler',
...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    items: [
      { id: 'oi-1', order_id: 'ord-901', menu_item_id: 'item-mah-1', name: 'Royal Malak Maharashtrian Thali', price: 360, quantity: 1 },
...
export const INITIAL_REVIEWS: Review[] = [
  {
    ...
    rating: 5,
    review: 'Hotel Malak serves the best Maharashtrian Thali and Ukadiche Modak in Kolhapur region! Outstanding taste and family environment.',
    sentiment: 'positive',
...
export const INITIAL_OFFERS: Offer[] = [
  {
    ...
    restaurant_id: 'rest-1',
    code: 'MALAK50',
    title: 'Get 50% OFF on Hotel Malak First Order',
